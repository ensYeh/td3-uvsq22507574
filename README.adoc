...
NOM et prenom: BATOCFETOU Ditorgma Komla Daniel
Lors de la compilation avec Maven, le plugin Checkstyle provoque une erreur de conflit de version Guava. Pour compiler et tester le projet, je fais :
